...
// (see playwright.config.ts + `pnpm test:e2e:coverage`) — a plain e2e run pays
// no instrumentation cost. Coverage is reported per test via monocart-reporter's
// `addCoverageReport`, which merges it into the run's global coverage report.
