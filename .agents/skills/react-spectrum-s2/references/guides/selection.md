...
function Example() {
  ...
  return (
    <>
      <Tabs aria-label="Tabs" selectedKey={selectedKey} onSelectionChange={setSelectedKey}>
        <TabList>
...
>
  ...
  <AssetCard id="hiking" textValue="Hiking Trail" onAction={() => alert('Opening Hiking Trail')}>
    <CardPreview>
      <Image
        src="https://images.unsplash.com/photo-1722233987129-61dc344db8b6?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        width={600}
...
<TableView aria-label="Table" selectionMode="multiple" styles={style({ width: 'full' })}>
  <TableHeader>
    <Column isRowHeader>Name</Column>
    <Column>Type</Column>
    <Column>Date Modified</Column>
...
>
  <TreeViewItem id="computer" textValue="My Computer">
    ...
    <TreeViewItem textValue="Documents" onAction={() => alert('Opening Documents')}>
      <TreeViewItemContent>Documents</TreeViewItemContent>
    </TreeViewItem>
...
<ComboBox label="Pokemon" placeholder="Select a Pokemon" defaultSelectedKey="pikachu">
...
<TableView aria-label="Pokemon" selectionMode="multiple" styles={style({ width: 'full' })}>
  <TableHeader>
    <Column isRowHeader>Name</Column>
    <Column>Type</Column>
    <Column>Level</Column>
...
<ToggleButtonGroup aria-label="Text style" selectionMode="multiple" defaultSelectedKeys={['bold']}>
  <ToggleButton id="bold">
    <TextBold />
    <Text>Bold</Text>
  </ToggleButton>
...
<MenuTrigger>
  <ActionButton>Pokemon</ActionButton>
  <Menu selectionMode="multiple" defaultSelectedKeys={[4]} disabledKeys={[3]} items={items}>
...
<TagGroup label="Pokemon" selectionMode="multiple" disabledKeys={[3]} items={items}>
