...
<TreeView aria-label="Files" styles={style({ width: 'full' })} defaultExpandedKeys={['documents']}>
...
function AsyncLoadingExample() {
  ...
  return (
    <TreeView aria-label="Async loading tree" styles={style({ height: 300, width: 'full' })}>
