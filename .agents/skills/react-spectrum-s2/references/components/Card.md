...
<Card>
  ...
  <Content>
    ...
    <Text slot="description">
      Card description. Give a concise overview of the context or functionality that's mentioned in
      the card title.
    </Text>
  </Content>
  <Footer>
...
<UserCard>
  ...
  <Content>
    ...
    <Text slot="description">
      Art Director at Luma Creative Studios. Visual storyteller and coffee enthusiast.
    </Text>
  </Content>
  <Footer>
    <StatusLight size="S" variant="positive">
...
<Card>
  ...
  <Content>
    ...
    <div
      className={style({ gridColumnEnd: 'span 2', display: 'flex', alignItems: 'center', gap: 8 })}
    >
      <Folder />
...
<Card>
  ...
  <Content>
    <div
      className={style({ display: 'flex', alignItems: 'center', justifyContent: 'space-between' })}
    >
