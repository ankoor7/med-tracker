...
<Form>
  <div role="group" className={style({ display: 'flex', alignItems: 'end', gap: 48 })}>
  ...
  >
    ...
    />
    {/*- begin highlight -*/}
    <LabeledValue label="Actual hours" value={0} styles={style({ width: 120 })} />
    {/*- end highlight -*/}
  </div>
  <div
    role="group"
    ...
    className={style({ display: 'flex', alignItems: 'end', gap: 48, font: 'ui' })}
  >
    <LabeledValue label="Project duration" value={1} styles={style({ width: 120 })} />
    <LabeledValue label="Actual duration" value={0} styles={style({ width: 120 })} />
  </div>
