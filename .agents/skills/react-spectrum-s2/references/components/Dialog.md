      ...
      <Dialog {...props}>
        {({ close }) => (
          <>
            ...
            <Content>
              <p>
                Enter your information to subscribe to our newsletter and receive updates about new
      ...
      <Dialog {...props}>
        {({ close }) => (
          <>
            ...
            <Content>
              <p>
                Standard dialog description. This should briefly communicate any additional
                information or context about the standard dialog title, to help users make one of
                the decisions offered by the buttons. Make it no more than a few short sentences.
              </p>
            </Content>
            <Footer>
              <Checkbox>Don't show this again</Checkbox>
      ...
      <FullscreenDialog {...props}>
        {({ close }) => (
          <>
            ...
            <Content>
              <p>
                This fullscreen dialog provides ample space for complex forms, detailed content, or
                multi-step workflows.
              </p>
              <p>
                The content area can scroll if needed, making it perfect for lengthy forms or
