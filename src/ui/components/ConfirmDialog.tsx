...
// as data loss.
//
// Rendered with role="alertdialog" (Stage 19 FR-19.3): this is the WAI-ARIA
// pattern for a dialog that interrupts to confirm a consequential action.
// Behaviour (confirm/cancel semantics + copy) is unchanged from Stage 18.
